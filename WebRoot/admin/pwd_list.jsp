...
<%
	request.setAttribute("title", "密码本管理");
%>
						...
						<div class="widget am-cf">
							<div class="widget-head am-cf">
								...
								<div class="widget-function am-fr">
									<a href="javascript:inc_pwd();"
										class="am-icon-plus-square am-icon-sm" title="新增密码"></a> <a
										href="javascript:import_pwd();"
										class="am-icon-code am-icon-sm" title="json导入"></a>
								</div>
							</div>
							<div class="widget-body  widget-body-lg am-fr">
								<div>
									<select id="js-selected"
										data-am-selected="{btnWidth: '20%', btnSize: 'sm', btnStyle: 'secondary'}"
										lay-verify="test" name="test">
									...
									<form class="tpl-header-search-form" action="javascript:;"
										...
										<input class="tpl-header-search-box" type="text"
											placeholder="搜索内容,回车提交" id="search">
									</form>
								</div>
								<div class="am-fl tpl-header-search"></div>

								<table class="layui-hide layui-bg-black" id="pwd_list"
									lay-filter="pwd_list"></table>
...
.layui-form input {
					...
					<div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
						<div class="widget am-cf">
							...
							<div class="widget-body am-fr">
								...
								<p>必要的参数有title:标题,descr:描述,user:用户名,pass:密码,weburl:网站地址</p>
								<p>非必要参数key:二代密码</p>
								<p>温馨提示:如果key参数不存在，将会使用普通token加密</p>
								<p>demo数据</p>
								<pre>[{'title':'测试1','descr':'测试1','username':'admin','pass':'pass','weburl':'google.com','key':''},{'title':'测试2','descr':'测试2','username':'admin','pass':'admin','weburl':'baidu.com','key':'xxxxx'}]</pre>
	...
	<script type="text/javascript">
		...
		function import_pwd() {
			...
			layui.use('form', function() {
				var form = layui.form;
				$("#json_arr_info").attr('placeholder', '[{"title":"测试1","descr":"测试1","username":"admin","pass":"pass","weburl":"google.com","key":"xxxxx"},{"title":"测试2","descr":"测试2","username":"admin","pass":"admin","weburl":"baidu.com","key":"xxxxx"}]');
