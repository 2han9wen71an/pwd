...
<body>
		...
		<div class="am-fr tpl-header-navbar">
			<ul>
				...
				<li class="am-text-sm tpl-header-navbar-welcome"><a
					href="javascript:;">欢迎你, <span>${user.username }</span>
				</a></li>
				...
				<!-- 新提示 -->
				<li class="am-dropdown" data-am-dropdown><a href="javascript:;"
					onclick="notepad_type()" class="am-dropdown-toggle"
					data-am-dropdown-toggle> <i class="am-icon-bell"></i> <span
						class="am-badge am-badge-warning am-round item-feed-badge"
						onclick="notepad_type()">${count }</span>
				</a> <!-- 弹出列表 -->
					<ul class="am-dropdown-content tpl-dropdown-content"
						id="notepad_type">正在获取……
					</ul></li>

				<!-- 退出 -->
				<li class="am-text-sm"><a href="javascript:;"> <a
						href="../zx"><span class="am-icon-sign-out"></span>
							退出</a>
				</a></li>
			</ul>
		</div>
	...
	<script type="text/javascript">
		function notepad_type() {
			$.ajax({
				url : 'notepad.do?method=notepad_type',
				type : 'GET',
				dataType : 'json',
			})
				.done(function(res) {
					...
					for (var i = 0; i < res['data'].length; i++) {
		                ...
		                <a href="notepad.jsp" class="tpl-dropdown-menu-notifications-item am-cf">\
