							...
							<div class="widget-body am-fr">
								...
								<form class="am-form tpl-form-line-form" id="doc-vld-msg">
									<div class="am-form-group">
										...
										<div class="am-u-sm-9">
											<input type="text" value="${user.username}" class="tpl-form-input" id="username" placeholder="请填写用户名" name="username" required minlength="3">
											<small id="info"></small>
										</div>
									</div>
									<div class="am-form-group">
										...
										<div class="am-u-sm-9">
											<input type="email" value="${user.email}" class="tpl-form-input js-pattern-email" id="email" placeholder="请填写邮箱地址" name="email" required>
											<small id="info"></small>
										</div>
									</div>
									<div class="am-form-group">
										...
										<div class="am-u-sm-9">
											<input type="number" value="${user.qq}" class="tpl-form-input" id="qq" placeholder="qq号" name="qq" required pattern="^[1-9][0-9]{4,}$">
											<small id="info"></small>
										</div>
									</div>
									<div class="am-form-group">
