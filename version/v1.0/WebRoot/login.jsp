...
#login-msg small {
	color: red;
				...
				<form class="am-form tpl-form-line-form" action="user?action=login"
					method="post" id="login-msg">
					...
					<div class="am-form-group">
						<input type="password" class="tpl-form-input" id="user-pass"
							placeholder="请输入密码" name="pass" minlength="6" required> <small
							id="info"></small>
					</div>
					<div class="am-form-group">
						<div class="col-sm-10">
					...
					<div class="am-form-group">
						<label for="user-intro"
							class="am-u-sm-6 am-form-label tpl-form-input">管理员登陆</label>
						<div class="am-u-sm-6">
							<div class="tpl-switch">
								<input type="checkbox"
									class="ios-switch bigswitch tpl-switch-btn" name="admin"
									id="admin">
					...
					<div class="am-form-group">
						<div class="am-u-sm-12">
							<div class="tpl-switch" style="text-align: right;">
								<a href="sign-up.jsp" style="color:#999;">注册</a>| <a
									href="reset_pwd.jsp" style="color:#999;">忘记密码？</a>
							</div>
						</div>
					</div>
					<div class="am-form-group">
						<button type="button"
							...
							name="submit" id="submit" disabled onclick="login();">提交</button>
					</div>
				</form>
			</div>
		</div>
	...
	<script type="text/javascript">
		...
		function re_code(obj) {
			d = new Date();
			$(obj).attr("src", "${pageContext.request.contextPath }/verifycode?" + d.getTime());
		}
